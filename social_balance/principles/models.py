...
class Jindicadores(models.Model):
    ...
    descripcionindicador = models.CharField(max_length=1000)
    ...
    variablesunidades = ArrayField(models.CharField(max_length=500), blank=True, null=True)
    variablesgrafico = ArrayField(models.CharField(max_length=500), blank=True, null=True)
    variablesgraficounidades = ArrayField(models.CharField(max_length=500), blank=True, null=True)
...
class Vindicators(models.Model):
    ...
    variables = ArrayField(models.CharField(max_length=500), blank=True, null=True)
...
class Vobjectivesvalues(models.Model):
    ...
    variablesgrafico = ArrayField(models.CharField(max_length=500), blank=True, null=True)
    resultado_grafico = ArrayField(models.CharField(max_length=500), blank=True, null=True)
