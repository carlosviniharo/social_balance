...
urlpatterns = [
    ...
    path("activeCorporations/", VcorporationsActiveView.as_view(), name="list-activecorporations"),
    ...
    path("activeDepartments/", VdepartmentsActiveView.as_view(), name="list-activedepartments"),
    ...
    path("departmentsByBranches/", VdepartmentsByBranchesView.as_view(), name="list-departmentsbybranches"),
    ...
    path("activeGeography/", VgeographyActiveView.as_view(), name="list-activegeography"),
    ...
    path("activeRoles/", VrolesActiveView.as_view(), name="list-activeroles"),
    ...
    path("rolesByDepartments/", VrolesByDepartmentsView.as_view(), name="list-rolesbydepartments"),
    ...
    path("activeBranches/", VbranchesActiveView.as_view(), name="list-activebranches"),
    ...
    path("branchesByCorporations/", VbranchesByCorporationView.as_view(), name="list-brachesbycorporations"),
