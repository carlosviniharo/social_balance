...
INSERT INTO public.jindicadores(codigoindicador,descripcionindicador,operacion, relacionproporcion, variables, variablesunidades, variablesgrafico, variablesgraficounidades, status, idprinciosubdivision) VALUES
 ...
 ARRAY['Número de capacitaciones ejecutadas en el año total', 'Número de capacitaciones planificadas en el año total'],
 ARRAY['capacitaciones', 'capacitaciones'],
 ARRAY['Número de capacitaciones no ejecutadas en el año total', 'Porcentaje de capacitaciones no ejecutadas sobre temas de gestión de los órganos de gobierno cooperativo, economía popular y solidaria, control interno, cuidado del ambiente, gobernanza, transparencia de información, inclusión y otros afines'],
 ...
 ARRAY['Número de capacitaciones ejecutadas en el año dirigidas a empleados', 'Número de capacitaciones planificadas en el año dirigidas a empleados'],
 ARRAY['capacitaciones', 'capacitaciones'],
 ARRAY['Número de capacitaciones no ejecutadas en el año dirigido a empleados', 'Porcentaje de capacitaciones o formación no ejecutadas, dirigidas a funcionarios sobre economía popular y solidaria, medio ambiente, responsabilidad social, transparencia de información, inclusión y otras afines'],
 ARRAY['capacitaciones', 'porcentaje'],
 true, 44),
...
('P504', 'Porcentaje de capacitaciones o formación ejecutadas, dirigidas a socios o representantes de la entidad sobre economía popular y solidaria, medio ambiente, principios del cooperativismo, responsabilidad social, transparencia de información, inclusión y afines', 'División', 'Porcentaje',
 ARRAY['Número de capacitaciones ejecutadas en el año dirigidas a socios o representantes', 'Número de capacitaciones planificadas en el año dirigidas a socios o representantes'],
 ARRAY['capacitaciones', 'capacitaciones'],
 ARRAY['Número de capacitaciones no ejecutadas en el año no dirigido a socios o representantes', 'Porcentaje de capacitaciones o formación no ejecutadas, dirigidas a socios o representantes de la entidad sobre economía popular y solidaria, medio ambiente, principios del cooperativismo, responsabilidad social, transparencia de información, inclusión y afines'],
 ARRAY['capacitaciones', 'porcentaje'],
 true, 44),
