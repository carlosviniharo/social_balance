...
INSERT INTO public.jindicadores(codigoindicador,descripcionindicador,operacion, variables, status, idprinciosubdivision) VALUES
 ...
 ('P701', 'Prácticas para medir la satisfacción del cliente', 'Cumplimiento', ARRAY['¿Tiene un procedimiento de medición de satisfacción del cliente, gestión de quejas y reclamos, incluyendo los resultados de los estudios de satisfacción?'], true, 53),
 ('P702', 'Porcentaje de satisfacción de acceso a productos y servicios', 'Igual', ARRAY['Promedio del porcentaje de satisfacción del acceso a productos y servicios financieros'], true, 53),
 ('P703', 'Gestión de quejas y reclamos', 'División', ARRAY['Número de quejas y reclamos atendidos en el año', 'Número de quejas y reclamos recibidas en el año'], true, 53),
 ('P704', 'Manual y políticas de gestión de reclamos', 'Cumplimiento', ARRAY['¿Tienen manuales aprobados por el CAD y actualizados que indiquen la política de gestión de quejas y reclamos?'], true, 53),
 ('P705', 'Exhibición de la información relacionada a productos y servicios en paneles de la entidad', 'Selección', ARRAY['Número de cuentas básicas aperturadas en el año'], true, 53),
 ('P706', 'Puntos de atención en zonas vulnerables', 'Igual', ARRAY['Número de puntos de atención ubicados en zonas vulnerables al corte'], true, 53),
 ('P707', 'Productos y servicios adaptados para personas vulnerables', 'Cumplimiento', ARRAY['¿Tienen productos y/o servicios adaptados para personas vulnerables?'], true, 53),
 ('P708', 'Infraestructura física para personas vulnerables', 'Cumplimiento', ARRAY['¿Tienen la infraestructura física que permita el acceso a los productos y/o servicios a personas vulnerables?'], true, 53),
 ('P709', 'Infraestructura tecnológica para personas vulnerables', 'Cumplimiento', ARRAY['¿Tienen la infraestructura tecnológica que permita el acceso a los productos y/o servicios a personas vulnerables?'], true, 53),
 ('P710', 'Políticas de colocación y captación que no incluyan costos asociados', 'Cumplimiento', ARRAY['¿Tienen políticas de colocación de créditos y captación de recursos, aprobadas por el CAD que no incluyan costos asociados?'], true, 53),
 ('P711', 'Políticas de colocación y captación que incluya la igualdad de oportunidades', 'Cumplimiento', ARRAY['¿Tienen políticas de colocación de créditos y captación de recursos, aprobadas por el CAD que incluya la igualdad de oportunidades?'], true, 53),
 ('P712', 'Políticas destinadas a las finanzas verdes', 'Cumplimiento', ARRAY['¿Tienen políticas aprobadas por el CAD para productos y servicios destinados a finanzas verdes?'], true, 54),
 ('P713', 'Productos y servicios destinados a finanzas verdes', 'Igual', ARRAY['Número de productos destinados a finanzas verdes en el año'], true, 54),
 ('P714', 'Porcentaje de cartera destinada a finanzas verdes', 'División', ARRAY['Saldo de créditos destinados a finanzas verdes al corte', 'Saldo cuenta 14-1499'], true, 54),
 ('P715', 'Socios beneficiados por finanzas verdes', 'Igual', ARRAY['Número de socios que han accedido a créditos destinados a finanzas verdes en el año'], true, 54),
 ('P716', 'Iniciativas para proporcionar productos y servicios enfocados en finanzas verdes', 'Igual', ARRAY['Número de iniciativas para proporcionar productos y servicios enfocados en la promoción de finanzas verdes en el año'], true, 54),
 ('P717', 'Capacitaciones que promueven la gestión e involucramiento en finanzas verdes', 'Igual', ARRAY['Número de capacitaciones ejecutadas en el año'], true, 54),
 ('P718', 'Iniciativas que incentiven las buenas prácticas ambientales en la entidad', 'Igual', ARRAY['Número de iniciativas que incentiven las buenas prácticas ambientales en la entidad en el año'], true, 54),
 ('P719', 'Iniciativas que incentiven las buenas prácticas ambientales en la comunidad o zona de influencia', 'Igual', ARRAY['Número de iniciativas que incentiven las buenas prácticas ambientales en la comunidad o zona de influencia en el año'], true, 54),
 ('P720', 'Convenios con Gobiernos Autónomos Descentralizados y/o con organismos gubernamentales que promuevan el desarrollo local o la sostenibilidad interinstitucional', 'Igual', ARRAY['Número de convenios vigentes con Gobiernos Autónomos Descentralizados y/o con organismos gubernamentales que promueven el desarrollo local o la sostenibilidad interinstitucional'], true, 55),
 ('P721', 'Políticas que promuevan la inclusión de proveedores locales de la EPS', 'Cumplimiento', ARRAY['¿Tiene políticas aprobadas por el CAD y actualizadas que promuevan la inclusión de proveedores locales de la EPS?'], true, 56),
 ('P722', 'Proveedores de la localidad calificados para establecer relaciones comerciales', 'División', ARRAY['Número de proveedores de la EPS, de la localidad, calificados y contratados en el año', 'Número de proveedores de la EPS contratados en el año'], true, 56),
 ('P723', 'Porcentaje del presupuesto destinado a compras a proveedores de la EPS', 'División', ARRAY['Monto de compras presupuestado a proveedores de la EPS en el año', 'Monto presupuesto de la entidad en el año'], true, 56),
 ('P724', 'Porcentaje del presupuesto efectivamente ejecutado en compras a proveedores de la EPS', 'División', ARRAY['Monto de compras real a proveedores de la EPS en el año', 'Monto presupuesto de la entidad en el año'], true, 56);
